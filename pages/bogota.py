...
st.set_page_config(layout="wide", page_title="Novus Vote - Bogotá", page_icon="🗳️")


# Add a title and intro text
st.title('Novus Vote 🗳️ Bogotá - 2023')
st.title('Central de Pre Campaña')
st.header('Votación Uribista al Congreso y Presidencia 2018')
